...
export default function UpdateUserModal({
  ...
  return (
    ...
    >
      <DialogContent className="max-h-[90vh] overflow-y-auto p-0 bg-linear-to-br from-white to-gray-50 dark:from-slate-900 dark:to-slate-950">
        <DialogHeader className="bg-linear-to-r from-amber-600 to-amber-700 text-white px-6 py-4 rounded-t-lg sticky top-0 z-10">
          <DialogTitle className="text-2xl font-bold flex items-center gap-2">
            <span className="text-amber-200">✎</span> Update Staff Member
          </DialogTitle>
